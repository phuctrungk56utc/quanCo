...
public class note extends quanTuong{
    ...
    public int inPut(note[] input, int Xuatphat ){
    ...
    public static void main(String[] args) {
        ...
        x.giaiThuat(banco, banco[xuatPhat], mang,ketQua);
        int buocMin;
        try {
            buocMin = mang.get(0);
            int len = mang.size();
            ...
            System.out.println("Ban nhap vi tri khong hop le,hay kiem tra lai");
            return;
        }
